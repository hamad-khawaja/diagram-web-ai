  ...
  return (
    <div>
      ...
      <main style={{maxWidth: 800, margin: "2rem auto", padding: "2.5rem 2rem 2rem 2rem", background: "#fff", borderRadius: 16, boxShadow: "0 2px 16px #2563eb11"}}>
        ...
        <h1 style={{fontSize: "2.2rem", fontWeight: 800, marginBottom: "1.5rem", color: '#2563eb', letterSpacing: '-0.01em', fontFamily: 'Sora, Inter, Montserrat, Arial, sans-serif'}}>Privacy Policy</h1>
        <div style={{fontSize: '1.13rem', color: '#334155', lineHeight: 1.7, fontFamily: 'Inter, Montserrat, Arial, sans-serif'}}>
          ...
          <h2 style={{marginTop: '2.2rem', color: '#a259ff', fontWeight: 700, fontSize: '1.18rem'}}>What We Collect</h2>
          ...
          <h2 style={{marginTop: '2.2rem', color: '#a259ff', fontWeight: 700, fontSize: '1.18rem'}}>Your Rights</h2>
          <ul style={{marginLeft: '1.2rem', marginBottom: '1.5rem'}}>
